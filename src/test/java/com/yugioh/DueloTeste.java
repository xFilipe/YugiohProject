...
public class DueloTeste {
  ...
  /*  Duelo duelo = new Duelo();
    ...
    public void preparar(){
        ...
        List<Duelista> jogadores = new ArrayList<>();
        ...
        System.out.println("VAlor da lista: " + jogadores);
        init(d1, d2);
    ...
    public void init(@NotNull Duelista dx1, @NotNull Duelista dx2){
        ...
        System.out.println(duelo.comecar(dx1, dx2));
        System.out.println(duelo.getArena().getPontoVida1());
        System.out.println(duelo.getDuelista1());
        System.out.println(duelo.getHoraInicio());
        System.out.println("carta sacada: " + duelo.getDuelista1().getDeckAtual().sacar());
        System.out.println("Nome do duelista 2 " + duelo.getDuelista2().getNome());
        System.out.println("Jogador atual: " + duelo.getJogadorAtual().getNome());
